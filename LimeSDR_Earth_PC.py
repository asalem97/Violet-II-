...
class LimeSDR_Earth_PC(gr.top_block, Qt.QWidget):

    def __init__(self, baud_rate=1200, dl_freq=145.91e6, rx_gain=56, sps=160, tx_gain=56, ul_freq=436830000):
        gr.top_block.__init__(self, "Earth PC with Doppler")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Earth PC with Doppler")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LimeSDR_Earth_PC")
        ...
        self.hdlc_framer_with_preamble_0 = hdlc_framer_with_preamble(
            ...
            num_preamble_bytes=10,
        )
        self.freq_xlating_fir_filter_xxx_1 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1,samp_rate,samp_rate/(2), 22000), 5000, 192000)
        ...
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.freq_xlating_fir_filter_xxx_1, 0))
    ...
    def set_baud_rate(self, baud_rate):
        ...
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(1, self.sps*self.baud_rate, 2*self.baud_rate, 0.0035, 160))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_1.set_taps(firdes.low_pass(1,self.samp_rate,self.samp_rate/(2), 22000))
...
def main(top_block_cls=LimeSDR_Earth_PC, options=None):
    if options is None:
