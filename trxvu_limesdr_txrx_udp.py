...
class trxvu_limesdr_txrx_udp(gr.top_block, Qt.QWidget):

    def __init__(self, baud_rate=1200, dl_freq=145.91e6, rx_gain=56, sps=160, tx_gain=56, ul_freq=436850000):
        ...
        self.settings = Qt.QSettings("GNU Radio", "trxvu_limesdr_txrx_udp")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1.0,samp_rate,1000,10000), 145.91e6, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1.0,self.samp_rate,1000,10000))
...
def argument_parser():
    ...
    parser.add_argument(
        "--ul-freq", dest="ul_freq", type=eng_float, default="436.85M",
        help="Set UL_Freq [default=%(default)r]")
    return parser


def main(top_block_cls=trxvu_limesdr_txrx_udp, options=None):
    if options is None:
